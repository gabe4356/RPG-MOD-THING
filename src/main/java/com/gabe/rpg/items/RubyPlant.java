...
public class RubyPlant extends BlockBush implements IGrowable
{
    public static final PropertyInteger BLOCKDATA = PropertyInteger.create("blockdata", 0, 7);
	  private String name = "RubyPlant";
    ...
    {
        return ground == RPGBlocks.RubyBlock;
    }
