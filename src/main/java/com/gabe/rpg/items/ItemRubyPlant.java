...
public class ItemRubyPlant extends Item implements IPlantable
{ 
    ...
    private String name = "RubySeeds";
    
    public ItemRubyPlant(Block par2, Block par3)
    {
  		setUnlocalizedName("RubySeeds");
